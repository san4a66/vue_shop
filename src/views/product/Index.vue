                    ...
                    <ul class="color-option">
                      <li v-for="color in filterList.colors">
                        <a @click.prevent="addColor(color.id)" href="#0" class="color-option-single"
                           :style="`background: #${color.title}`"> <span>{{ color.title }}</span> </a></li>
                    </ul>
                  </div>
                  <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                        ...
                        <div v-for="product in products" class="col-xl-4 col-lg-6 col-6 ">
                          <div class="products-three-single w-100  mt-30">
                            ...
                            <div class="products-three-single-content text-center">
                              ...
                              <h5>
                                <router-link :to="{name: 'products.show', params: {id: product.id}}">{{ product.title }}
                                </router-link>
                              </h5>
                              <p>
                                <del>$200.00</del>
      ...
      this.axios.get(`http://localhost:8876/api/products/filters`)
          .then(res => {
            ...
            if ($("#price-range").length) {
              $("#price-range").slider({
                range: true,
                min: parseFloat(this.filterList.price.min),
                max: parseFloat(this.filterList.price.max),
                values: [parseFloat(this.filterList.price.min), parseFloat(this.filterList.price.max)],
